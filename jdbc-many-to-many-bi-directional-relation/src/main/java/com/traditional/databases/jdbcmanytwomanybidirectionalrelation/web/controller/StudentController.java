...
public class StudentController {
    ...
    public Mono<ResponseEntity<StudentResponse>> createStudent(@RequestBody StudentRequest studentRequest) {
    ...
    public Mono<ResponseEntity<StudentResponse>> updateStudent(@PathVariable Long studentId, @RequestBody StudentRequest studentRequest) {
